defmodule TestPhxApiWeb.Auth.Guardian do
  use Guardian, otp_app: :test_phx_api
  alias TestPhxApi.Accounts
  ...
  # we need to overwrite these functions that are already used by guardian
